    ...
    public void onBindViewHolder(@NonNull @NotNull SymbolAdapter.ViewHolderSymbol holder, int position) {
        ...
        if (symbols.get(position).getChangePrecent() != null) {
            ...
            if (Float.parseFloat(symbols.get(position).getChangePrecent()) > 0) {
                if (symbols.get(position).getChangePrecent().length() > 4) {
                    holder.txtSymbolChange.setText("+" + symbols.get(position).getChangePrecent().substring(0, 4) + "%");
                } else {
                    holder.txtSymbolChange.setText("+" + symbols.get(position).getChangePrecent() + "%");
                }
                ...
                if (symbols.get(position).getChangePrecent().length() > 5) {
            ...
            public void run() {
                ...
                if (newLastValue - currentLastValue >= 0) {
                    if (String.valueOf(newLastValue).length() > 9) {
                        ...
                        holder.txtSymbolLast.setText(String.valueOf(newLastValue));
                    }
                ...
                public void run() {
                    ...
                    if (newChangeValue > 0) {
                        if (String.valueOf(newChangeValue).length() > 4) {
                            ...
                            holder.txtSymbolChange.setText("+" + String.valueOf(newChangeValue) + "%");
                        }
                        holder.txtSymbolChange.setTextColor(Color.GREEN);
                        ...
                        if (String.valueOf(newChangeValue).length() > 3) {
                            holder.txtSymbolChange.setText(String.valueOf(newChangeValue).substring(0, 3) + "%");
                        } else {
                            holder.txtSymbolChange.setText(String.valueOf(newChangeValue) + "%");
                        }
                        holder.txtSymbolChange.setTextColor(Color.WHITE);
